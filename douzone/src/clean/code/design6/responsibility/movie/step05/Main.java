...
public class Main {
    public static void main(String [] args) {
        ...
        //할인 정책 객체생성
        AmountDiscountPolicy amountDiscountPolicy = new AmountDiscountPolicy(Money.wons(800), sequenceCondition1, sequenceCondition10, periodCondition1, periodCondition2);
        PercentDiscountPolicy percentDiscountPolicy = new PercentDiscountPolicy(0.1, periodCondition3, sequenceCondition2, periodCondition4);
